...
$stmt = $mysqli->prepare('INSERT INTO lectures (user_id, 
name, subject, duration, date_time, category, location, area_all, 
...
area_bi, summary, requirements) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
$stmt->bind_param('issssssssssssssssssssssssssss', $_POST['user_id'], 
$_POST['name'], $_POST['subject'], $_POST['duration'], $_POST['date'],$_POST['category'],
...
$_POST['process'],$_POST['bi'],$_POST['summary'],$_POST['requirements']);
