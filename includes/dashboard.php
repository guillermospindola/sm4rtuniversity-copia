...
<body class="fix-header card-no-border logo-center">
    ...
    <div id="main-wrapper">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav active">
                        <ul id="sidebarnav" class="in">
                            ...
                            <li class="two-column">
                                 <a class="has-arrow" href="./courses" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Cursos</span></a>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="tablaAnual" class="table table-bordered table-striped" style="height: 300px;">
                                        <thead>
                                            <tr>
                                                <th>Rank</th>
                                                <th>Nombre</th>
       ...
       <?php
       $i=1;
 $sql = "SELECT id, name, picture, coursesducy + certsducy + projectsducy AS sdus FROM members ORDER BY sdus DESC";
        ...
        {           echo "<tr> 
                    ...
                    <a href='profile.php?id=".$row['id']."&name=".$row['name']."'><a class='mytooltip tooltip-effect-8' href='./profile.php?id=".$row['id']."'><img class='img-circle' src='".$row['picture']."' height='40' width='40'></img><span class='tooltip-content2'><i class='fa fa-user'></i></span></a>
...
<div class="col-lg-6">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="tablaHistorico" class="table table-bordered table-striped" style="height: 100px;">
                                        <thead>
                                            <tr>
                                                <th>Rank</th>
                                                <th>Nombre</th>
...
$sql = "SELECT id, name, picture, coursesdu + certsdu + projectsdu AS sdus FROM members ORDER BY sdus DESC";
        $query = mysqli_query($mysqli, $sql); 
        $i=1;
        while ($row = mysqli_fetch_array($query))
        {           echo "<tr> 
