            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Proyectos y Propuestas</h3>
                        <ol class="breadcrumb">
                ...
                <!-- ============================================================== -->
                <div>
                <button onclick="infoNewProject()" class="btn waves-effect waves-light btn-primary">Nuevo Proyecto</button><br></div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Proyectos de los que soy miembro</h6>
...
$sql = "SELECT * FROM proposals 
        WHERE leader='".$_SESSION['email']."'
        OR member1='".$_SESSION['email']."'
        OR member2='".$_SESSION['email']."'
        ORDER BY created";
                    ...
                    <td>'.$row['status'].'</td>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Proyectos dados de alta en SM4RT UNIVERSITY</h6>
                                <div class="table-responsive m-t-40">
...
$sql = "SELECT * FROM proposals ORDER BY created";
        $query = mysqli_query($mysqli, $sql); 
...
if (strlen($row['description']) > 50)
	...
	<!-- Mensaje de alerta -->
	<script>
	function infoNewProject() {
            swal({
                title: "Convocatorias no Activas",
                text: "El registro de nuevos proyectos se activará en las fechas especificadas en las convocatorias."
