            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Mis solicitudes de Cursos y Certificaciones</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Detalle sobre las solicitudes que has enviado.</h6>
...
$sql = "SELECT courses_members.fecha_solicitud AS fsol,
		courses_members.user_id AS uid,
		courses_members.course_id AS cid, 
		courses_members.status_solicitud AS ssol, 
		courses_members.comentarios_solicitud AS csol, courses.name AS cname
		FROM courses_members, courses 
        WHERE courses.id = courses_members.course_id 
		AND courses_members.user_id = '".$_SESSION['id']."'
        ...
        {           echo '<tr> 
                    ...
                    <td>'.$row['ssol'].'</td>
                    <td>'.$row['csol'].'</td>
					<td><a href="./includes/cancel_request.php?uid='.$row['uid'].'&cid='.$row['cid'].'" class="btn btn-danger">Cancelar</a></td>
                </tr>';
        }?> 
                                        </tbody>
                                    </table>
