...
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge"> <style id="antiClickjack">body{display:none !important;}</style>
                            ...
                            <li class="two-column">
                                <a class="has-arrow" href="" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Formación</span></a>
                                 <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="./certifications.php">Certificaciones</a></li> <li><a href="./my-requests.php">Mis solicitudes</a></li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-block">
                                <h1 class="card-title"><?php echo $_GET['name'];?></h1>
								<h6>Los cursos y certificaciones están sujetos a disponibilidad.</h6>
                                <br>
                                <h4>Descripción:</h4>
                                ...
                                <h4>Valor en SDU's:</h4>
                                <?php echo $_GET['value'];?>
                                <br>
                                <br>

                                <form action="./includes/update_requested.php" name="solicitar">
                               <div class="form-actions">
                               
                               <input hidden name="curso" id="curso" value="<?php echo $_GET['id']?>">
                               <input hidden name="tipo" id="tipo" value="<?php echo $_GET['type']?>">

                                        <button type="button" onclick="confirmRequest()" class="btn btn-success"> <i class="fa fa-check" ></i> Solicitar</button>
...
<script>
	function confirmRequest() {
            swal({
                ...
                text: "Tu solicitud fue registrada con éxito, será evaluada por el equipo de Capacitación. Los cursos y certificaciones están sujetos a disponibilidad.",
                type: "success",
                //timer: 3000
            }, 
            function(){
              window.location.href = "./includes/update_requested.php?<?php echo "id=".$_GET['id']."&type=".$_GET['type']?>";
            });
}
	</script>
    <script>
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
        <script src="./assets/plugins/styleswitcher/jQuery.style.switcher.js"></script><script type="text/javascript">if (self === top) {var antiClickjack = document.getElementById("antiClickjack");antiClickjack.parentNode.removeChild(antiClickjack);} else {top.location = self.location;}</script>
</body>
