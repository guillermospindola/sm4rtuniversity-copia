                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav active">
                        <ul id="sidebarnav" class="in">
                            ...
                            <li class="two-column">
                                 <a class="has-arrow" href="" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Formación</span></a>
                                 <ul aria-expanded="false" class="collapse">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-block">
                                <form action="./includes/register_lecture.php" enctype="multipart/form-data" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                               <div class="form-group">
											    <input hidden type="text" name="user_id" value="<?php echo $_SESSION['id'];?>">
                    ...
                    <option value="Conferencia">Conferencia</option>
                                                    ...
                                                    <input required type="text" id="duration" name="duration" class="form-control">
                                                    <small class="form-control-feedback">Número de sesiones</small>  </div>

                                                											
													<div class="form-group">
													<label for="inicio" >Fecha y hora</label>
													<input required class="form-control" type="datetime-local" id="date" name="date">
													</div>
                    ...
                    <option value="Santa Fe">Santa Fe</option></select> </div>                               
											
									<div class="form-group">
                                    <label>Resumen o temario</label>
                                    <textarea required class="form-control" rows="7" id="summary" name="summary"></textarea></div>
									
									<div class="form-group">
                                    <label>Requisitos para asistentes</label>
                                    <textarea required class="form-control" rows="7" id="requiremets" name="requirements"></textarea></div>
                                            </div>
                                            <!--/span-->
                                        <!--/row-->
                                    ...
                                    <input type="checkbox" id="all" name="all" value="si">
                                    <label for="all">Todas las áreas</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="directors" name="directors" value="si">
                                    <label for="directors">Directores</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="managers" name="managers" value="si">
                                    <label for="managers">Gerentes</label>
                                </div>
                                                    
													<div class="demo-checkbox">
                                    <input type="checkbox" id="leaders" name="leaders" value="si">
                                    <label for="leaders">Coordinadores/Líderes/Supervisores</label>
                                </div>
								
								 <div class="demo-checkbox">
                                    <input type="checkbox" id="pm" name="pm" value="si">
                                    <label for="pm">PM</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="implementation" name="implementation" value="si">
                                    <label for="implementation">Implementación</label>
                                </div>
                                                    
													<div class="demo-checkbox">
                                    <input type="checkbox" id="vm" name="vm" value="si">
                                    <label for="vm">VM</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="qa" name="qa" value="si">
                                    <label for="qa">Calidad</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="cm" name="cm" value="si">
                                    <label for="cm">Change Management</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="rh" name="rh" value="si">
                                    <label for="rh">Capital Humano</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="admin" name="admin" value="si">
                                    <label for="admin">Administración y finanzas</label>
                                </div>
								
								<div class="demo-checkbox">
                                    <input type="checkbox" id="sales" name="sales" value="si">
                                    <label for="sales">Vendedores</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="sd" name="sd" value="si">
                                    <label for="sd">SD</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="presale" name="presale" value="si">
                                    <label for="presale">Preventa</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="soc" name="soc" value="si">
                                    <label for="soc">SOC</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="sl" name="sl" value="si">
                                    <label for="sl">Líderes de Servicio</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="cess" name="cess" value="si">
                                    <label for="cess">CESS</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="app" name="app" value="si">
                                    <label for="app">Aplicaciones</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="process" name="process" value="si">
                                    <label for="process">Procesos y Auditoría</label>
                                </div>
								<div class="demo-checkbox">
                                    <input type="checkbox" id="bi" name="bi" value="si">
