                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Cursos disponibles en SM4RT</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="allProjects" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
<?php
$sql = "SELECT * FROM courses WHERE type='Curso' ORDER BY name";
        ...
        {           echo '<tr> 
                    ...
                    <td>'.$row['value'].'</td>
                    <td><a href="coursecertdetail.php?type=courses&id='.$row['id'].'&name='.urlencode($row['name']).'&description='.urlencode($row['description']).'&value='.$row['value'].'" class="btn btn-info">Detalle</a></td>
