    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Editar Curso</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Edicion de Cursos</h4>
                            </div>
      ...
      ?>
	   <div class="form-group">
                                 ...
                                 <select id="class" onchange="setValue()" name="class" <?php echo $hidden;?> class="form-control custom-select">
...
if(d=='N/A'){document.getElementById('value').value='5';}
if(d=='Curso'){document.getElementById('value').value='5';}
if(d=='Diplomado'){document.getElementById('value').value='50';}
if(d=='Maestria'){document.getElementById('value').value='100';}
if(d=='Doctorado'){document.getElementById('value').value='100';}
else{}				
}
</script>
    <!-- ============================================================== -->
