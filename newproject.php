            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Nuevo Proyecto</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Registro de Proyecto</h4>
                            </div>
                            <div class="card-block">
                                <form action="./includes/register_proposal.php" enctype="multipart/form-data" method="post">
                                    <div class="form-body">
                                ...
                                <input required type="file" id="myFile" name="myFile" class="form-control" aria-invalid="false">
                                </div>
