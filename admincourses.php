    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <button type="submit" class="btn waves-effect waves-light btn-primary">Nuevo Curso</button>
                </form>
                <br>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Lista de todos los cursos registrados</h6>
...
$sql = "SELECT * FROM courses WHERE type='Curso'";
...
if (strlen($row['description']) > 50)
	...
	echo '<tr> 
                    ...
                    <td>'.$row['value'].'</td>
                    <td>'.$row['active'].'</td>
               <td><a href="editcert.php?id='.$row['id'].'&name='.urlencode($row['name']).'&active='.$row['active'].'&description='.urlencode($row['description']).'&value='.$row['value'].'&class='.$row['class'].'&type=Curso" class="btn btn-danger">Editar</a></td></tr>';}?> 
                                        </tbody>
                                    </table>
                                </div>
                            </div>
