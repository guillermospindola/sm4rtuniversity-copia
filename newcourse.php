            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Nuevo Curso</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Registro Curso</h4>
                            </div>
                                            ...
                                            <div class="col-md-6">
                                               <div class="form-group">
                                                    ...
                                                    <input required type="text" id="name" name="name" class="form-control" >
                                                      <small class="form-control-feedback"> Nombre del curso </small>  </div>
            
                                                     <div class="form-group">
                                                    <label class="control-label">Valor</label>
                                                    <input required type="number" id="value" name="value" value="5" class="form-control" >
                                                    <small class="form-control-feedback"> SDU's que suma este curso (5 por defecto)</small>  </div>

                                    <input hidden type="text" id="certification" name="certification" value="Curso" >
