                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-block">
								...
								$user=getUserInfo ($id, $mysqli);
										echo $_GET['coursename'];?></h3>
                                        <hr>
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                               <div class="form-group">
                                               <?php
                                                $stmt = $mysqli->prepare("SELECT provider, certificate, certfile, added, validity FROM courses_members WHERE user_id =? AND course_id=?");
												$stmt->bind_param('i',$_GET['userid'], $_GET['courseid']);
												$stmt->execute();
