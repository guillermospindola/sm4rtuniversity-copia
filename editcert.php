            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Editar Curso/Certificación</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Editar Curso/Certificación</li>
                        </ol>
                    </div>
                     <?php 
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Edicion de Curso / Certificación</h4>
                            </div>
                            <div class="card-block">
                                <form action="./includes/update_coursecert.php" enctype="multipart/form-data" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                               <div class="form-group">
                                                    ...
                                                    <input required type="text" id="name" name="name" class="form-control" value="<?php echo $_GET['name']; ?>" >
                                                      <small class="form-control-feedback"> Nombre de la certificación</small>  </div>
            
                                                     <div class="form-group">
                                                     <input hidden id="valueold" name="valueold" value="<?php echo $_GET['value']; ?>">
                                                    <label class="control-label">Valor</label>
                                                    <input required type="number" id="value" name="value" class="form-control" value="<?php echo $_GET['value']; ?>">
									...
									if($_GET['type']=='Curso')
								{
                                    ...
                                    <input <?php echo $hiddenpath;?> type="checkbox" id="path" name="path" value="si" <?php echo $path;?>>
                                    <label for="path" <?php echo $hiddenpath;?>>Fin de path o nivel más avanzado</label>
                                </div>
								...
								?>
  <div class="form-group">
                                 <label <?php echo $hidden;?>>Tipo de Curso</label>
                                 <select id="class" name="class" <?php echo $hidden;?> class="form-control custom-select">
					<option value="N/A">N/A</option>
                    <option value="Curso" <?php if($_GET['class']=='Curso'){echo "selected='selected'";}?>>Curso</option>
                    <option value="Diplomado" <?php if($_GET['class']=='Diplomado'){echo "selected='selected'";}?>>Diplomado</option>
                    <option value="Maestria" <?php if($_GET['class']=='Maestria'){echo "selected='selected'";}?>>Maestría</option>
                    <option value="Doctorado" <?php if($_GET['class']=='Doctorado'){echo "selected='selected'";}?>>Doctorado</option>
					
                                                    </select>
                                                    <small class="form-control-feedback" <?php echo $hidden;?>> Clasificación del curso</small>
                                                    </div> 
                                            </div>
                                            <!--/span-->
                                    ...
                                    <textarea required class="form-control" rows="7" id="description" name="description"><?php echo $_GET['description']; ?></textarea></div>

                                     <?php
       if($_GET['active']=='Activo')
       {
          $checked="checked"; 
       }
      ...
      ?>
                                        ...
                                        <div class="switch">
                                            <label>Inactivo
                                                <input id="active" name="active" type="checkbox" <?php echo $checked?>><span class="lever switch-col-light-green"></span>Activo</label>
                                        </div></div>    
