...
class Course extends \Chamilo\CoreBundle\Entity\Course implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'id', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'title', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'code', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'directory', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'courseLanguage', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'description', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'categoryCode', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'visibility', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'showScore', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'tutorName', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'visualCode', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'departmentName', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'departmentUrl', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'diskQuota', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'lastVisit', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'lastEdit', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'creationDate', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'expirationDate', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'subscribe', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'unsubscribe', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'registrationCode', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'legal', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'activateLegal', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'addTeachersToSessionsCourses', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'courseTypeId', 'users', 'urls', 'sessions', 'sessionUserSubscriptions', 'tools', '' . "\0" . 'Chamilo\\CoreBundle\\Entity\\Course' . "\0" . 'room', 'currentSession', 'issuedSkills'];
        }
    ...
    public function getNotebooks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNotebooks', []);

        return parent::getNotebooks();
    }
    ...
    public function getAbsoluteSysCoursePath()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAbsoluteSysCoursePath', []);

        return parent::getAbsoluteSysCoursePath();
    }
    ...
    public function hasPicture()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasPicture', []);
    ...
    public function getPicturePath($fullSize = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPicturePath', [$fullSize]);

        return parent::getPicturePath($fullSize);
    }
