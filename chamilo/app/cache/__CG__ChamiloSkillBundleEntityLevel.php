...
namespace DoctrineProxies\__CG__\Chamilo\SkillBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Level extends \Chamilo\SkillBundle\Entity\Level implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'position', 'shortName', 'profile'];
        }
