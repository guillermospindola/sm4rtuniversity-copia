            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Ponencias</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Ponencias</h4>
                                <h6 class="card-subtitle">Ponencias solicitadas, aprobadas y completas</h6>
...
$sql = "SELECT * FROM lectures";
        ...
        {           echo '<tr> 
					...
					<td>'.$row['status'].'</td>
					<td>'.$row['comments'].'</td>
					<td><a href="editlecture.php?id='.$row['id'].'" class="btn btn-danger">Editar</a></td>
                </tr>';
        }?> 
                                        </tbody>
                                    </table>
