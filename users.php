                    ...
                    <nav class="sidebar-nav active">
                        <ul id="sidebarnav" class="in">
                            ...
                            <li class="three-column">
                                <a class="has-arrow" href="./projects.php" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i><span class="hide-menu">Proyectos</span></a>                               <ul aria-expanded="false" class="collapse">                                     <li><a href="./announcement.php">Convocatorias</a></li>                                    <li><a href="./projects.php">Registrar Proyecto</a></li>                                </ul>                               <li class="two-column">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Lista de todos los usuarios</h6>
...
$sql = "SELECT * FROM members";
        ...
        {           echo '<tr> 
                    ...
                    <td>'.$row['email'].'</td>
                    <td>'.$row['direccion'].'</td>
                    <td><a href="edituser.php?id='.$row['id'].'&name='.urlencode($row['name']).'&location='.$row['location'].'&nempleado='.$row['numero_empleado'].'&impartidos='.$row['cursos_impartidos'].'&direccion='.$row['direccion'].'&abroad='.$row['abroad'].'&bomb='.$row['bomberazo'].'&combo='.$row['combo'].'" class="btn btn-danger">Editar</a></td></tr>';}?> 
                                    </tbody>
                                    </table>
                                </div>
                            </div>
