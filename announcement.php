                    ...
                    <nav class="sidebar-nav active">
                        <ul id="sidebarnav" class="in">
                            ...
                            <li class="three-column">
                                <a class="has-arrow" href="" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i><span class="hide-menu">Proyectos</span></a>                               
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
							...
							<br><br>
                                <h2 class="card-title">Espera las próximas convocatorias.</h2>
