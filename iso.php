            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">ISO 27001</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">ISO 27001</li>
                        </ol>
                    </div>
                    <?php 
                ...
                <div class="row">
                <a href="iso2.pdf"><p class="complementario">Material complementario</p></a>
                    <div class="col-12" style="height: 600px !important;">

                        <div class="card" >
                            
                                <object data="./iso.pdf" type="application/pdf" style="height: 600px !important;">
        <embed src="./iso.pdf" type="application/pdf" />
    </object>
