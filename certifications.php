            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Certificaciones</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                   <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                    <div class="ribbon ribbon-default">Combo 1</div>
									<div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">PMP + CISSP o CISA + CERTIFIED ISO/IEC 27001 LEAD AUDITOR o IMPLEMENTER + ITIL FUNDAMENTOS<br></p>
									</div>
                                </div>
                            </div>
							  <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                    <div class="ribbon ribbon-danger">Combo 2</div>
									<div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">CERTIFIED ISO/IEC 27001 LEAD AUDITOR o IMPLEMENTER + MANAGING ACROSS THE LIFECYCLE / ITIL EXPERT</p>
									</div>
                                </div>
                            </div>
							  <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                    <div class="ribbon ribbon-success">Combo 3</div>
									<div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">CISA + CISM + CISSP + CRISC + ITIL FUNDAMENTOS</p>
									</div>
                                </div>
                            </div>
							  <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                    <div class="ribbon ribbon-primary">Combo 4</div>
									<div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">COBIT FOUNDATION + CISSP o CISA o CISM</p>
									</div>
                                </div>
                            </div>
							<div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                    <div class="ribbon ribbon-info">Combo 5</div>
									<div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">ADVANCED SECURITY PRACTIONER CAS CAS-002 + CISSP</p>
									</div>
                                </div>
                            </div>
							  <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                   <div class="ribbon ribbon-warning">Combo 6</div>
								   <div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">PMP + CISM + ITIL FUNDAMENTOS</p>
									</div>
                                </div>
                            </div>
							  <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                <div class="ribbon-wrapper-reverse card">
                                   <div class="ribbon ribbon-default">Combo 7</div>
								   <div style="overflow-y: auto; height:50px;">
                                    <p class="ribbon-content">SEC501: ADVANCED SECURITY ESSENTIALS - ENTERPRISE DEFENDER (GCED) + EC-COUNCIL FORENSIC INVESTIGATOR CHFI</p>
									</div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Certificaciones disponibles en SM4RT</h6>
                                <div class="table-responsive m-t-40" style="width: 100%;">
                                    <table id="certifications" class="table table-bordered table-striped" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Institución</th>
                                        ...
                                        <tbody>
<?php
$sql = "SELECT * FROM courses WHERE type='Certificacion' AND active = 'Activo' ORDER BY name";
        ...
        { 
          ...
          echo '<tr> 
                    ...
                    <td>'.$str.'</td>
                    <td>'.$row['value'].'</td>
                    <td><a href="coursecertdetail.php?type=certifications&id='.$row['id'].'&name='.urlencode($row['name']).'&description='.urlencode($row['description']).'&value='.$row['value'].'" class="btn btn-info">Detalle</a></td>
