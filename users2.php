...
<body class="fix-header card-no-border logo-center">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav active">
                        <ul id="sidebarnav" class="in">
                            ...
                            <li class="two-column">
                                 <a class="has-arrow" href="./courses" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Formación</span></a><ul aria-expanded="false" class="collapse"><li><a href="./courses.php">Cursos</a></li><li><a href="./certifications.php">Certificaciones</a></li></ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Administración de proyectos</h3>
                        <ol class="breadcrumb">
                ...
                <button type="submit" class="btn waves-effect waves-light btn-primary">Nuevo Proyecto</button>
                </form>
                <br>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Lista de todos los proyectos</h6>
                                <div class="table-responsive m-t-40">
                                    </table>
                                        <table id="myProjects" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Email</th>
    ...
    $sql = "SELECT * FROM members";
            ...
            {           echo '<tr> 
                        ...
                        <td>'.$row['area'].'</td>
                        <td>'.$row['direccion'].'</td>
                        <td><a href="editproject.php?id='.$row['id'].'&name='.urlencode($row['name']).'&description='.urlencode($row['description']).'&leader='.$row['leader'].'&member1='.$row['member1'].'&member2='.$row['member2'].'&status='.$row['status'].'&value='.$row['value'].'" class="btn btn-danger">Editar</a></td></tr>';
            }?> 
                                            </tbody>
                                        </table>
                                </div>
