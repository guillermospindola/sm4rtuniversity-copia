            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Reglamento</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-12" style="height: 600px !important;">
                        ...
                        <div class="card" >
                                ...
                                <object data="./reglamento.pdf" type="application/pdf" style="height: 600px !important;">
        <embed src="./reglamento.pdf" type="application/pdf" />
    </object>
