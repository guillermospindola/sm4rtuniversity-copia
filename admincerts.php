            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Administración de Certificaciones</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Administración de Certificaciones</li>
                        </ol>
                    </div>
                    <?php 
                ...
                <button type="submit" class="btn waves-effect waves-light btn-primary">Nueva Certificación</button>
                </form>
                <br>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Lista de todas las certificaciones</h6>
...
$sql = "SELECT * FROM courses WHERE type='Certificacion'";
...
if (strlen($row['description']) > 50)
			{
				...
				$str=$row['description'];
                    ...
                    <td>'.$row['value'].'</td>
                    <td>'.$row['active'].'</td>
                    <td><a href="editcert.php?id='.$row['id'].'&name='.urlencode($row['name']).'&active='.$row['active'].'&path='.$row['path'].'&description='.urlencode($row['description']).'&value='.$row['value'].'&type=Certificacion" class="btn btn-danger">Editar</a></td></tr>';}?> 
                                        </tbody>
                                    </table>
                                </div>
                            </div>
